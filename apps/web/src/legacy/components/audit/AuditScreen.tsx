...
const AUDIT_EVENTS = [
  { icon: 'result', iconClass: 'ti-x', actor: 'Nadim Sharif', desc: <>marked <span className="audit-ref">TC-1004</span> as <span className={statusPillClass('fail')}>Fail</span> <span style={{ color: 'var(--relay-muted)' }}>(was Not run)</span></>, ctx: 'CTMS Regression — Sprint 44 · execution result change', time: '1h ago' },
  { icon: 'link', iconClass: 'ti-bug', actor: 'Nadim Sharif', desc: <>linked defect <span className="audit-ref">TI-4419</span> to <span className="audit-ref">TC-2041</span></>, ctx: 'CTMS Regression — Sprint 44 · defect linked', time: '2h ago' },
  { icon: 'result', iconClass: 'ti-check', actor: 'Monica Dayalani', desc: <>marked <span className="audit-ref">TC-1012</span> as <span className={statusPillClass('pass')}>Pass</span> <span style={{ color: 'var(--relay-muted)' }}>(was Not run)</span></>, ctx: 'SSO/IAM Role Matrix — Permission Validation', time: '3h ago' },
  { icon: 'edit', iconClass: 'ti-edit', actor: 'Nasir Dipto', desc: <>updated preconditions on <span className="audit-ref">TC-1008</span></>, ctx: 'CTMS · Reporting suite · content edit', time: '4h ago' },
  ...
  { icon: 'assign', iconClass: 'ti-user', actor: 'Noel Quadri', desc: <>assigned <span className="audit-ref">TC-1007</span> to <strong>Nadim Sharif</strong></>, ctx: 'Viewer suite · assignee change', time: '2d ago' },
  { icon: 'edit', iconClass: 'ti-edit', actor: 'Nadim Sharif', desc: <>changed priority of <span className="audit-ref">TC-1007</span> from <strong>High</strong> → <strong>Critical</strong></>, ctx: 'Viewer · Grid & filtering suite', time: '2d ago' },
  ...
  { icon: 'create', iconClass: 'ti-file-plus', actor: 'Nasir Dipto', desc: <>created test case <span className="audit-ref">TC-1013</span> <em style={{ color: 'var(--relay-muted)', fontSize: 11 }}>Viewer pagination resets on filter clear</em></>, ctx: 'Viewer · Grid & filtering suite', time: '5d ago' },
