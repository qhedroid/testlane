...
function mapExecCases(runId: string): ExecCase[] {
  const raw: Array<{
    ...
    { id: 'TC-2041', title: 'CTMS user role mapping drops Viewer permission', status: 'fail', by: 'Nadim Sharif', pri: 'critical', precond: 'CTMS test tenant contains seeded Admin, Executor, and Reader users with module-level permissions enabled.', steps: [
    ...
    { id: 'TC-2042', title: 'eTMF bulk upload preserves document classifications', status: 'not_run', by: 'Nadim Sharif', pri: 'critical', precond: 'eTMF module has bulk upload enabled and five sample PDFs ready.', steps: [
    ...
    { id: 'TC-2043', title: 'Viewer grid count updates after filter changes', status: 'pass', by: 'Nasir Dipto', pri: 'high', precond: 'Viewer module has seeded rows across multiple statuses.', steps: [
    ...
    { id: 'TC-2044', title: 'Reader cannot approve eTMF workflow item', status: 'pass', by: 'Monica Dayalani', pri: 'high', precond: 'Reader user has access to an eTMF document in QC review.', steps: [
    ...
    { id: 'TC-2045', title: 'Admin can reopen sealed test run', status: 'not_run', by: "Jamil Khan", pri: 'medium', precond: 'Completed test run is sealed with failed executions.', steps: [
    ...
    { id: 'TC-2046', title: 'Reporting export blocks when run data is still syncing', status: 'blocked', by: "Jamil Khan", pri: 'medium', precond: 'Run result aggregation job is still in progress.', steps: [
    ...
    { id: 'TC-2047', title: 'Archived CTMS record remains visible in audit history', status: 'not_run', by: 'Syed Ahmed', pri: 'low', precond: 'CTMS record has historical edits and linked audit events.', steps: [
    ...
    { id: 'TC-2048', title: 'SSO/IAM role change syncs to module permissions', status: 'pass', by: 'Monica Dayalani', pri: 'high', precond: 'User has Executor access to CTMS and eTMF modules.', steps: [
    ...
    { id: 'TC-2050', title: 'Import legacy regression test cases from Excel', status: 'not_run', by: 'Nasir Dipto', pri: 'medium', precond: 'Valid .xlsx template with 50 test cases populated.', steps: [
  ...
  const runs: TestRun[] = [
    {
      ...
      stalled: false,
      assignees: [
        { name: 'Nadim Sharif', cases: 48 },
        { name: 'Shaun Sevume', cases: 35 },
        { name: 'Nasir Dipto', cases: 31 },
        { name: 'Monica Dayalani', cases: 17 },
      ],
    ...
    },
    {
      ...
      stalled: false,
      assignees: [
        { name: "Jamil Khan", cases: 18 },
        { name: 'Nasir Dipto', cases: 12 },
        { name: 'Monica Dayalani', cases: 10 },
      ],
      defects: ['TI-4421'],
    ...
    },
    {
      ...
      stalled: false,
      assignees: [
        { name: 'Nasir Dipto', cases: 38 },
        { name: 'Monica Dayalani', cases: 29 },
    ...
    },
    {
      ...
      stalled: false,
      assignees: [
        { name: "Jamil Khan", cases: 14 },
        { name: 'Nadim Sharif', cases: 10 },
      ],
      defects: [],
      cases: ctmsCases.slice(0, 3),
    },
