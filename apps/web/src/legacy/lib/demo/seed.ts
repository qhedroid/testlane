...
function mapCases(): TestCase[] {
  const raw: Array<{
    ...
    { id: 'TC-1001', suite: 'CTMS', section: 'Role & permissions', title: 'Validate CTMS role permissions for Viewer user', pri: 'critical', type: 'Functional', last: 'pass', by: 'Aisha R.', steps: 4, upd: '2d ago', precond: 'CTMS test tenant has Admin, Executor, and Reader users seeded for permission testing.', stepList: [
    ...
    { id: 'TC-1002', suite: 'CTMS', section: 'Record management', title: 'Create CTMS record with required fields', pri: 'critical', type: 'Functional', last: 'pass', by: 'Aisha R.', steps: 3, upd: '2d ago', precond: 'Executor user has CTMS create permission in UAT.', stepList: [
    ...
    { id: 'TC-1003', suite: 'eTMF', section: 'Document upload', title: 'eTMF document upload preserves classification metadata', pri: 'critical', type: 'Functional', last: 'pass', by: 'James O.', steps: 5, upd: '3d ago', precond: 'eTMF test project contains a configured document workflow and sample PDF.', stepList: [
    ...
    { id: 'TC-1004', suite: 'CTMS', section: 'Role & permissions', title: 'CTMS user role mapping preserves Viewer permission', pri: 'high', type: 'Functional', last: 'fail', by: 'Aisha R.', steps: 4, upd: '1d ago', precond: 'CTMS module has a Viewer user assigned through SSO/IAM role mapping.', stepList: [
    ...
    { id: 'TC-1005', suite: 'eTMF', section: 'Document upload', title: 'Bulk upload eTMF documents routes each file to workflow', pri: 'high', type: 'Functional', last: 'pass', by: 'Marcus W.', steps: 5, upd: '4d ago', precond: 'eTMF document workflow is enabled and bulk upload test files are available.', stepList: [
    ...
    { id: 'TC-1006', suite: 'Viewer', section: 'Read-only permissions', title: 'Reader cannot edit configuration in Viewer module', pri: 'high', type: 'Security', last: 'pass', by: 'James O.', steps: 3, upd: '5d ago', precond: 'Reader user has access to Viewer module dashboards.', stepList: [
    ...
    { id: 'TC-1007', suite: 'Viewer', section: 'Grid & filtering', title: 'Viewer grid filter refreshes result count', pri: 'critical', type: 'Integration', last: 'fail', by: 'Aisha R.', steps: 4, upd: '1d ago', precond: 'Viewer module contains seeded records across multiple statuses.', stepList: [
    ...
    { id: 'TC-1008', suite: 'Reporting', section: 'Export', title: 'Reporting export includes skipped and not-run executions', pri: 'critical', type: 'Functional', last: 'fail', by: 'Aisha R.', steps: 3, upd: '1d ago', precond: 'Completed test run contains Passed, Failed, Blocked, Skipped, and Not run executions.', stepList: [
    ...
    { id: 'TC-1009', suite: 'GlobalLearn', section: 'Course completions', title: 'GlobalLearn completion syncs to user training widget', pri: 'medium', type: 'Integration', last: 'pass', by: 'Marcus W.', steps: 3, upd: '6d ago', precond: 'Test user has assigned GlobalLearn training in the integration environment.', stepList: [
    ...
    { id: 'TC-1010', suite: 'eTMF', section: 'Classification & QC', title: 'Document workflow metadata survives status transition', pri: 'medium', type: 'Functional', last: 'pass', by: 'Priya N.', steps: 4, upd: '3d ago', precond: 'Document workflow has Draft, QC review, Approved, and Rejected states.', stepList: [
    ...
    { id: 'TC-1011', suite: 'CTMS', section: 'Audit history', title: 'Archive inactive CTMS record without losing audit history', pri: 'low', type: 'Functional', last: 'not_run', by: 'Fatima A.', steps: 2, upd: '7d ago', precond: 'CTMS record has prior edits and linked audit history.', stepList: [
    ...
    { id: 'TC-1012', suite: 'SSO/IAM', section: 'Role mapping & sync', title: 'SSO/IAM role change propagates to module permissions', pri: 'high', type: 'Security', last: 'pass', by: 'Priya N.', steps: 2, upd: '5d ago', precond: 'User has Executor access to CTMS and eTMF modules.', stepList: [
...
function mapExecCases(runId: string): ExecCase[] {
  const raw: Array<{
    ...
    { id: 'TC-2041', title: 'CTMS user role mapping drops Viewer permission', status: 'fail', by: 'Aisha Rahman', pri: 'critical', precond: 'CTMS test tenant contains seeded Admin, Executor, and Reader users with module-level permissions enabled.', steps: [
    ...
    { id: 'TC-2042', title: 'eTMF bulk upload preserves document classifications', status: 'not_run', by: 'Aisha Rahman', pri: 'critical', precond: 'eTMF module has bulk upload enabled and five sample PDFs ready.', steps: [
    ...
    { id: 'TC-2043', title: 'Viewer grid count updates after filter changes', status: 'pass', by: 'Marcus Webb', pri: 'high', precond: 'Viewer module has seeded rows across multiple statuses.', steps: [
    ...
    { id: 'TC-2044', title: 'Reader cannot approve eTMF workflow item', status: 'pass', by: 'Priya Nair', pri: 'high', precond: 'Reader user has access to an eTMF document in QC review.', steps: [
    ...
    { id: 'TC-2045', title: 'Admin can reopen sealed test run', status: 'not_run', by: "James O'Sullivan", pri: 'medium', precond: 'Completed test run is sealed with failed executions.', steps: [
    ...
    { id: 'TC-2046', title: 'Reporting export blocks when run data is still syncing', status: 'blocked', by: "James O'Sullivan", pri: 'medium', precond: 'Run result aggregation job is still in progress.', steps: [
    ...
    { id: 'TC-2047', title: 'Archived CTMS record remains visible in audit history', status: 'not_run', by: 'Fatima Al-Amin', pri: 'low', precond: 'CTMS record has historical edits and linked audit events.', steps: [
    ...
    { id: 'TC-2048', title: 'SSO/IAM role change syncs to module permissions', status: 'pass', by: 'Priya Nair', pri: 'high', precond: 'User has Executor access to CTMS and eTMF modules.', steps: [
    ...
    { id: 'TC-2050', title: 'Import legacy regression test cases from Excel', status: 'not_run', by: 'Marcus Webb', pri: 'medium', precond: 'Valid .xlsx template with 50 test cases populated.', steps: [
  ...
  const runs: TestRun[] = [
    {
      ...
      stalled: false,
      assignees: [
        { name: 'Aisha Rahman', cases: 48 },
        { name: 'Shaun Sevume', cases: 35 },
        { name: 'Marcus Webb', cases: 31 },
        { name: 'Priya Nair', cases: 17 },
      ],
    ...
    },
    {
      ...
      stalled: false,
      assignees: [
        { name: "James O'Sullivan", cases: 18 },
        { name: 'Marcus Webb', cases: 12 },
        { name: 'Priya Nair', cases: 10 },
      ],
      defects: ['TI-4421'],
    ...
    },
    {
      ...
      stalled: false,
      assignees: [
        { name: 'Marcus Webb', cases: 38 },
        { name: 'Priya Nair', cases: 29 },
    ...
    },
    {
      ...
      stalled: false,
      assignees: [
        { name: "James O'Sullivan", cases: 14 },
        { name: 'Aisha Rahman', cases: 10 },
      ],
      defects: [],
      cases: ctmsCases.slice(0, 3),
    },
  ...
  return [
    {
      ...
      spawnedRuns: [
        { id: 'R1', status: 'active', name: 'CTMS Regression — Sprint 44', meta: 'Started 2d ago · Aisha R.' },
    ...
    },
    {
      ...
      spawnedRuns: [
        { id: 'R2', status: 'active', name: 'eTMF Document Workflow Smoke — Pre-release', meta: 'Started 4h ago · James O.' },
    ...
    },
    {
      ...
      spawnedRuns: [
        { id: 'R4', status: 'active', name: 'Reporting Module — Integration Suite', meta: 'Started 1d ago · Marcus W.' },
...
const ATTENTION: AttentionItem[] = [
  { id: 'A1', title: 'CTMS user role mapping drops Viewer permission after save', priority: 'critical', runName: 'CTMS Regression · Sprint 44', actor: 'Aisha R. · 1h' },
  { id: 'A2', title: 'Viewer grid filter does not refresh row count after change', priority: 'critical', runName: 'Viewer Module Regression', actor: 'Priya N. · 4h' },
  { id: 'A3', title: 'Document classification applies wrong type after bulk upload', priority: 'high', runName: 'eTMF Document Workflow Smoke', actor: 'Marcus W. · 2h' },
  { id: 'A4', title: 'Run summary export omits skipped execution rows', priority: 'high', runName: 'Reporting Module · Integration Suite', actor: 'James O. · 3h', defectId: 'TI-4421' },
  { id: 'A5', title: 'Bulk API import drops request header metadata', priority: 'high', runName: 'API Gateway Regression', actor: 'Marcus W. · 8h' },
  { id: 'A6', title: 'Reader role can access executor-only test action endpoint', priority: 'medium', runName: 'SSO/IAM Role Matrix', actor: 'Fatima A. · 6h', defectId: 'TI-4398' },
]
