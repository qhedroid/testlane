...
### Dashboard Metrics `[~draft]`
Provisional notes at `docs/cursor-prompts/mvp-dashboard-metrics/draft-notes.md`.

Original ask: "Do it: Project Scope → Test Plans Scope." (i.e. scope dashboard metrics to a selected Test Plan rather than/in addition to the whole project.)
